...
public class TelaAtualizarRequerente extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public TelaAtualizarRequerente(Requerente umRequerente) {
		setResizable(false);
		...
		txtNome = new JTextField(umRequerente.getNome());
		...
		txtTelefone = new JTextField(umRequerente.getTelefone());
		...
		txtRg = new JTextField(umRequerente.getRg());
		...
		txtCpf = new JTextField(umRequerente.getCpf());
